...
<section class="bg-white  py-24 px-4 lg:px-16"> 
    <div class="container mx-auto px-[12px] md:px-24 xl:px-12 max-w-[1300px] nanum2">
        <h1 class="text-center text-6xl pb-12 my-20">MyStock</h1>
                ...
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            ...
                            <img src="https://cdn11.bigcommerce.com/s-uqrbx0uqh/images/stencil/1280x1280/products/7151/21914/Air_Jordan_1_Mid_Lakers_2022_-DQ8426-517-0__35383.1667394260.png?c=1"
                                class="w-auto h-auto  mt-6 m-auto" alt="Automotive" title="Automotive" loading="lazy"
